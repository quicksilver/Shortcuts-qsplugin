//
//  QSShortcutsPlugin_Unit_Tests.swift
//  QSShortcutsPlugin Unit Tests
//
...
import QSShortcutsPlugin

class QSShortcutsPlugin_Unit_Tests: XCTestCase {
    ...
    func testExample() throws {
        let action = QSShortcutsPluginSwiftAction()
